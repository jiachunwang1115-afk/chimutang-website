...
var SPACE_MEDIA=[
  paving({id:"living-hero",src:"journal/paving-reference/ref-living-hero.webp",alt:"通透客厅与用餐区原木地板铺装参考",headline:"一厅两景",subline:"起居与用餐同木相连",roomType:"客厅",colorTone:"原木",styleTag:"自然侘寂",pattern:"通铺长板",mood:"明亮",wood:"橡木",series:"境系列",summary:"同一片原木地面把用餐区、电视区和窗边动线连在一起。强日照下明暗变化明显，选色时要同时观察亮面与阴影。",detailPoints:["空间观感：低矮家具与连续地面放大横向开间。","木色建议：中性原木色更容易平衡日照区与背光区。","铺法建议：沿主要开间连续排板，柱边与电视地台需提前收口。"],support:["oakNatural","section"],productFilter:{series:"境系列",wood:"橡木"},featured:true}),
  paving({id:"living-light",src:"journal/paving-reference/ref-living-light.webp",alt:"整面采光客厅浅木地板铺装参考",headline:"窗边轻厅",subline:"浅木承接整面采光",roomType:"客厅",colorTone:"浅木",styleTag:"现代极简",pattern:"通铺长板",mood:"明亮",wood:"橡木",series:"悦系列",summary:"整面落地窗、白墙与轻量座椅已经足够通透，浅木地面只需补上温度。自然色差不宜过强，以免抢走窗景。",detailPoints:["空间观感：开敞、轻盈，悬吊椅与小体量家具更突出。","木色建议：浅橡木或柔和原木色能保留明度。","铺法建议：保持门洞内外同向排板，减少开敞空间的切割感。"],support:["oakLight","maintenance"],productFilter:{series:"悦系列",wood:"橡木"},featured:true}),
  paving({id:"living-dark-lounge",src:"journal/paving-reference/ref-living-dark-lounge.webp",alt:"明亮小型会客区中棕木地板铺装参考",headline:"小厅有序",subline:"中棕稳住黑色家具",roomType:"休闲区",colorTone:"中棕",styleTag:"现代极简",pattern:"通铺长板",mood:"柔光",wood:"橡木",series:"境系列",summary:"白墙、轨道灯和百叶窗让小会客区保持明亮，中棕地面负责压住黑色皮椅的重量。这里需要的是平衡，而不是更深的木色。",detailPoints:["空间观感：小尺度空间清爽，深色家具仍有落点。","木色建议：中棕或自然橡木比深胡桃更适合这类明亮小厅。","铺法建议：短向空间保持连续排板，避免在座椅区增加复杂拼花。"],support:["oakBrown","maintenance"],productFilter:{series:"境系列",wood:"橡木"},featured:true}),
  paving({id:"living-soft-sofa",src:"journal/paving-reference/ref-living-soft-sofa.webp",alt:"天窗客厅中棕木地板铺装参考",headline:"柔光会客",subline:"中棕托住浅灰软装",roomType:"客厅",colorTone:"中棕",styleTag:"自然侘寂",pattern:"通铺长板",mood:"柔光",wood:"橡木",series:"森系列",summary:"天窗与落地窗带来两种方向的光，中棕地面让浅灰沙发不至于漂浮。木纹有变化，但整体色阶保持克制。",detailPoints:["空间观感：柔和、耐看，适合日常家庭会客。","木色建议：偏灰的中棕更容易与浅灰织物协调。","铺法建议：沿客厅长向连续排板，保留通往窗边的完整动线。"],support:["oakBrown","maintenance"],productFilter:{series:"森系列",wood:"橡木"},featured:true}),
  paving({id:"living-warm-classic",src:"journal/paving-reference/ref-living-warm-classic.webp",alt:"木顶卧室与会客区浅木地板铺装参考",headline:"木顶卧居",subline:"睡眠与会客共处一室",roomType:"卧室",colorTone:"浅木",styleTag:"自然侘寂",pattern:"宽板",mood:"柔光",wood:"欧橡",series:"森系列",summary:"这是一间把睡眠、收纳与小会客区放在一起的开敞卧室。浅木顶与低明度地板相互呼应，能容纳古典家具而不过分厚重。",detailPoints:["空间观感：卧室尺度开阔，床与会客椅各自成区。","木色建议：灰调浅木可平衡古典柜体与皮革座椅。","铺法建议：宽板顺房间长向排布，顶地纹理不必完全同向。"],support:["oakLight","section"],productFilter:{series:"森系列",wood:"欧橡"},featured:true}),
  paving({id:"dining-open",src:"journal/paving-reference/ref-dining-open.webp",alt:"开放客餐厨中棕木地板铺装参考",headline:"餐厨相连",subline:"中棕承接三段动线",roomType:"餐厨",colorTone:"中棕",styleTag:"自然侘寂",pattern:"通铺长板",mood:"温润",wood:"橡木",series:"境系列",summary:"餐桌、吧台与沙发在同一开间内，地面不能再做额外分区。中棕通铺把三种生活动线连成一个完整日常。",detailPoints:["空间观感：餐厨与起居区连续，家具边界更清楚。","木色建议：中棕能承接白色柜体和暖木家具，也较耐日常痕迹。","铺法建议：跨越餐桌与吧台连续排板，尽量减少门槛和分色。"],support:["oakBrown","skirting"],productFilter:{series:"境系列",wood:"橡木"},featured:true}),
  paving({id:"dining-light",src:"journal/paving-reference/ref-dining-light.webp",alt:"餐桌与睡眠区共处的浅木人字拼参考",headline:"一室两用",subline:"浅木划出餐桌与睡眠区",roomType:"多功能区",colorTone:"浅木",styleTag:"现代极简",pattern:"人字拼",mood:"明亮",wood:"橡木",series:"悦系列",summary:"餐桌与床处在同一开放房间，人字拼提供了足够的视觉边界，不必再用高柜或地面高差分隔。浅木色让两种功能保持轻盈。",detailPoints:["空间观感：用纹理而非隔断区分用餐与休息。","木色建议：浅木低色差能避免小空间显得零碎。","铺法建议：先以房间主轴定位人字中心线，再处理床边和窗边收口。"],support:["oakLight","section"],productFilter:{series:"悦系列",wood:"橡木"},featured:true}),
  paving({id:"dining-minimal",src:"journal/paving-reference/ref-dining-minimal.webp",alt:"灰调木作餐厅通铺地板参考",headline:"餐厅作轴",subline:"灰调木纹连接前后空间",roomType:"餐厨",colorTone:"烟熏灰",styleTag:"意式沉稳",pattern:"通铺长板",mood:"沉静",wood:"橡木",series:"墨系列",summary:"餐桌、石材柱与通透隔架共同形成中轴，灰调木地板把前后空间连起来。明显木纹保留材质感，同时与深色木作拉开层次。",detailPoints:["空间观感：餐厅成为开放空间的稳定中心。","木色建议：烟熏灰或灰棕色能协调石材、黑色金属与深木作。","铺法建议：沿餐厅至后场的动线连续排板，避免在隔架处断开。"],support:["smoke","section"],productFilter:{series:"墨系列",wood:"橡木"},featured:true}),
  paving({id:"kitchen-ceiling",src:"journal/paving-reference/ref-kitchen-ceiling.webp",alt:"裸露木梁餐厨与中棕地板铺装参考",headline:"梁下餐厨",subline:"暖木平衡裸露木梁",roomType:"餐厨",colorTone:"中棕",styleTag:"自然侘寂",pattern:"通铺长板",mood:"温润",wood:"橡木",series:"森系列",summary:"裸露梁架已经提供了强烈木感，地面用更沉稳的中棕色承接，避免顶、地、柜体都落在同一亮度。白色弧形岛台因此更显轻。",detailPoints:["空间观感：木梁有结构感，地面负责稳定下半部。","木色建议：地面可比顶面深半到一阶，保留空间层次。","铺法建议：地板按主要通行动线排布，不必机械追随梁向。"],support:["oakBrown","section"],productFilter:{series:"森系列",wood:"橡木"},featured:false}),
  paving({id:"kitchen-long",src:"journal/paving-reference/ref-kitchen-long.webp",alt:"开放餐厨长桌与浅木地板铺装参考",headline:"长桌成心",subline:"开放餐厨围桌展开",roomType:"餐厨",colorTone:"浅木",styleTag:"现代极简",pattern:"通铺长板",mood:"明亮",wood:"橡木",series:"境系列",summary:"一张长桌组织备餐、用餐与通行，形成开放餐厨的中心。浅木地面让黑色厨房、楼梯与彩色餐椅保持轻重平衡。",detailPoints:["空间观感：长桌组织用餐、备餐与通行三条动线。","木色建议：浅木或自然橡木能缓和黑色柜体的重量。","铺法建议：沿长桌与主要通道连续排板，桌下不另做分区。"],support:["oakLight","maintenance"],productFilter:{series:"境系列",wood:"橡木"},featured:false}),
  paving({id:"kitchen-family",src:"journal/paving-reference/ref-kitchen-family.webp",alt:"家庭餐厨与工作台原木地板铺装参考",headline:"家务共桌",subline:"餐厨与工作台共享木色",roomType:"餐厨",colorTone:"原木",styleTag:"自然侘寂",pattern:"宽板",mood:"柔光",wood:"橡木",series:"悦系列",summary:"餐桌、收纳柜与一侧工作台共同构成家庭餐厨。原木色地面把烹饪、用餐和轻办公放在同一种温度里。",detailPoints:["空间观感：功能丰富但不拥挤，适合高频家庭使用。","木色建议：自然原木色可与柜体同调，纹理不必完全一致。","铺法建议：宽板贯穿餐桌与工作台，柜体落位前确认边界收口。"],support:["oakNatural","repair"],productFilter:{series:"悦系列",wood:"橡木"},featured:false}),
  paving({id:"bedroom-light",src:"journal/paving-reference/ref-bedroom-light.webp",alt:"抬高休闲平台浅木地板铺装参考",headline:"抬高一隅",subline:"浅木平台留给阅读与独处",roomType:"休闲区",colorTone:"浅木",styleTag:"现代极简",pattern:"宽板",mood:"明亮",wood:"橡木",series:"悦系列",summary:"抬高的浅木平台留出一处阅读与独处的位置。木色从地面延续到平台边缘，让一把椅子也能形成清楚、安静的停留区域。",detailPoints:["空间观感：抬高关系明确，小空间仍有停留感。","木色建议：浅木可减轻平台体量，并与白墙和高窗协调。","铺法建议：平台立面、踏步与平面需统一收口，先定完成面高度。"],support:["oakLight","section"],productFilter:{series:"悦系列",wood:"橡木"},featured:false}),
  paving({id:"bedroom-deep",src:"journal/paving-reference/ref-bedroom-deep.webp",alt:"窗边休闲区深色人字拼地板参考",headline:"窗边静坐",subline:"深色人字拼收住临窗一角",roomType:"休闲区",colorTone:"深胡桃",styleTag:"意式沉稳",pattern:"人字拼",mood:"沉静",wood:"黑胡桃",series:"墨系列",summary:"临窗软包长凳与深色护墙围出安静的休闲角。深色人字拼把窗边和坐凳收在同一尺度里，适合阅读与短暂停留。",detailPoints:["空间观感：包裹感集中在窗边，适合阅读或短暂停留。","木色建议：深棕色可与酒红织物、深色护墙形成同一色阶。","铺法建议：小面积人字拼先定窗线与坐凳边界，避免边缘碎拼。"],support:["deep","section"],productFilter:{series:"墨系列",wood:"黑胡桃"},featured:false}),
  paving({id:"bedroom-warm",src:"journal/paving-reference/ref-bedroom-warm.webp",alt:"双面采光客厅中棕木地板铺装参考",headline:"暖阳客厅",subline:"中棕木色连接两面采光",roomType:"客厅",colorTone:"中棕",styleTag:"自然侘寂",pattern:"通铺长板",mood:"明亮",wood:"橡木",series:"森系列",summary:"双面开窗为客厅带来充足日照。中棕地面承接白色沙发与深木茶几，在亮面和阴影之间保持温度。",detailPoints:["空间观感：采光充足，家具少而开敞。","木色建议：暖中棕比浅白木更能稳住大面积日照。","铺法建议：连续排板穿过两组窗线，避免在茶几区另做边框。"],support:["oakBrown","maintenance"],productFilter:{series:"森系列",wood:"橡木"},featured:false}),
  paving({id:"study-shadow",src:"journal/paving-reference/ref-study-shadow.webp",alt:"材质玄关中棕木地板铺装参考",headline:"材质入门",subline:"高色差木纹对照素白墙面",roomType:"玄关",colorTone:"中棕",styleTag:"现代极简",pattern:"通铺长板",mood:"柔光",wood:"橡木",series:"境系列",summary:"画面没有书桌或书墙，更接近入户过厅。素白肌理墙、深色门片与高色差木地板形成明确的材质对照。",detailPoints:["空间观感：家具很少，地面纹理成为第一视觉。","木色建议：中棕高色差适合大留白，但相邻房间宜减少花纹。","铺法建议：从门口建立整板起点，窄墙和门套处优先控制收口。"],support:["oakBrown","skirting"],productFilter:{series:"境系列",wood:"橡木"},featured:false}),
  paving({id:"study-chair",src:"journal/paving-reference/ref-study-chair.webp",alt:"双椅休闲区中棕木地板铺装参考",headline:"双椅静谈",subline:"显纹木地板为小会客区增温",roomType:"休闲区",colorTone:"中棕",styleTag:"自然侘寂",pattern:"通铺长板",mood:"柔光",wood:"橡木",series:"境系列",summary:"两把休闲椅与低几构成小型会客区，墙面几乎留白。中棕地板的显著纹理因此成为空间主要的温度来源。",detailPoints:["空间观感：适合阅读、对谈，陈设克制。","木色建议：自然色差可保留，但灯光下不宜过红。","铺法建议：普通长板即可，避免再叠加复杂地毯纹样。"],support:["oakBrown","maintenance"],productFilter:{series:"境系列",wood:"橡木"},featured:false}),
  paving({id:"tea-room-dark",src:"journal/paving-reference/ref-tea-room-dark.webp",alt:"木顶榻榻米茶室原木铺装参考",headline:"木顶茶席",subline:"顶面温木，地面留给坐席",roomType:"茶室",colorTone:"原木",styleTag:"东方静奢",pattern:"木作一体",mood:"柔光",wood:"欧橡",series:"森系列",summary:"榻榻米茶席居中，原木集中在顶面、窗边平台与侧边步道。清楚的木作边界托住坐席，也让灰墙和黑色构件保有留白。",detailPoints:["空间观感：茶席居中，木作围绕四周形成安定边界。","木色建议：温和原木色可与灰墙、黑色构件保持轻重平衡。","铺法建议：先确定榻榻米模数，再统一平台、步道与顶面的收口关系。"],support:["oakNatural","section"],productFilter:{series:"森系列",wood:"欧橡"},featured:false}),
  paving({id:"tatami-light",src:"journal/paving-reference/ref-tatami-light.webp",alt:"障子格栅多功能室浅木地板铺装参考",headline:"障子明室",subline:"浅木与格栅扩散自然光",roomType:"多功能区",colorTone:"浅木",styleTag:"东方静奢",pattern:"通铺长板",mood:"明亮",wood:"橡木",series:"悦系列",summary:"空房以障子格栅、木顶和浅木地面共同扩散自然光，可作为瑜伽、亲子或临时会客空间。低色差让用途变化时仍容易布置。",detailPoints:["空间观感：明净、开敞，功能保持弹性。","木色建议：低色差浅木能维持光线均匀，避免地面抢眼。","铺法建议：长板沿空间长向通铺，门洞处保持连续。"],support:["oakLight","section"],productFilter:{series:"悦系列",wood:"橡木"},featured:false}),
  paving({id:"japanese-quiet",src:"journal/paving-reference/ref-japanese-quiet.webp",alt:"茶席边界与原木步道铺装参考",headline:"席边素木",subline:"木地板只做茶席的安静边界",roomType:"茶室",colorTone:"原木",styleTag:"东方静奢",pattern:"木作一体",mood:"柔光",wood:"橡木",series:"森系列",summary:"榻榻米是主角，木地板只出现在临窗步道和茶席边缘。纹理与色差越克制，坐席、矮桌和自然光越完整。",detailPoints:["空间观感：坐席低、视线平，木步道负责界定边缘。","木色建议：素雅原木色应接近窗框与顶面，不必完全同色。","铺法建议：先按榻榻米模数定位边框，再处理临窗窄条收口。"],support:["oakNatural","skirting"],productFilter:{series:"森系列",wood:"橡木"},featured:false}),
  paving({id:"entry-slats",src:"journal/paving-reference/ref-entry-slats.webp",alt:"玻璃移门客厅中棕木地板通铺参考",headline:"移门之后",subline:"连续木地板穿过玻璃分隔",roomType:"客厅",colorTone:"中棕",styleTag:"现代极简",pattern:"通铺长板",mood:"明亮",wood:"橡木",series:"境系列",summary:"从玻璃移门望向客厅，连续木地板穿过黑框分隔，使前区与会客区保持同一尺度，也让视线自然向内延伸。",detailPoints:["空间观感：玻璃分隔存在，但地面让视线持续向内。","木色建议：中棕可以平衡黑框、白墙与棕色休闲椅。","铺法建议：移门轨道两侧保持板向一致，重点处理轨道收边。"],support:["oakBrown","skirting"],productFilter:{series:"境系列",wood:"橡木"},featured:false}),
  paving({id:"corridor-wood",src:"journal/paving-reference/ref-corridor-wood.webp",alt:"双床卧室模块拼木地板与木顶参考",headline:"双床木室",subline:"模块拼地面回应木质顶面",roomType:"卧室",colorTone:"中棕",styleTag:"东方静奢",pattern:"模块拼",mood:"明亮",wood:"橡木",series:"境系列",summary:"双床卧室以不同方向的小板块组成几何秩序，地面与木质顶面、白砖电视墙相互呼应，材质丰富但层次清楚。",detailPoints:["空间观感：两张床并列，地面拼法为宽房间增加横向节奏。","木色建议：中棕模块拼可呼应木顶，墙面宜保持浅色。","铺法建议：以床尾或电视墙为基准排版，边缘预留完整模块。"],support:["oakBrown","section"],productFilter:{series:"境系列",wood:"橡木"},featured:false}),
  paving({id:"hall-open",src:"journal/paving-reference/ref-hall-open.webp",alt:"转角落地窗客厅原木地板铺装参考",headline:"转角见景",subline:"开窗小厅需要克制木纹",roomType:"客厅",colorTone:"原木",styleTag:"现代极简",pattern:"通铺长板",mood:"明亮",wood:"橡木",series:"悦系列",summary:"转角落地窗为小客厅带来开阔景深。原木地面以平直纹理承接窗景，让黑色沙发和深木茶几保持清楚的视觉落点。",detailPoints:["空间观感：窗景成为主视觉，地面保持安静。","木色建议：自然原木色可保留明度，也能压住深色家具。","铺法建议：沿主要视线连续排板，转角窗边避免过碎收口。"],support:["oakNatural","maintenance"],productFilter:{series:"悦系列",wood:"橡木"},featured:false}),
  paving({id:"stairs-open",src:"journal/paving-reference/ref-stairs-open.webp",alt:"庭院旁开放楼梯与浅木地板铺装参考",headline:"楼梯连庭",subline:"地面与踏步衔接室内外",roomType:"楼梯",colorTone:"浅木",styleTag:"自然侘寂",pattern:"木作一体",mood:"明亮",wood:"橡木",series:"森系列",summary:"开放楼梯紧邻庭院玻璃门，室内浅木地面、深色踏步与室外木平台形成三层材质关系。地面不必追求完全同色，重点是过渡清楚。",detailPoints:["空间观感：楼梯和庭院共同成为室内主景。","木色建议：室内浅木可提亮，踏步用深一阶形成安全识别。","铺法建议：优先校准门槛、首级踏步和室外平台三处标高。"],support:["nosing","section"],productFilter:{series:"森系列",wood:"橡木"},featured:false}),
  paving({id:"stairs-silent",src:"journal/paving-reference/ref-stairs-silent.webp",alt:"斜顶阁楼过道原木地板铺装参考",headline:"斜顶连层",subline:"长板顺着阁楼动线延伸",roomType:"楼梯",colorTone:"原木",styleTag:"现代极简",pattern:"通铺长板",mood:"柔光",wood:"橡木",series:"悦系列",summary:"画面是楼梯上方的阁楼过道。斜顶与低矮边墙压低了空间，原木地板和浅木顶面共同减轻了狭长感。",detailPoints:["空间观感：低矮、狭长，但光线和木色保持轻盈。","木色建议：中性原木色比深色更适合斜顶与低净高。","铺法建议：沿通行动线连续排板，栏杆与立柱周边先做整板规划。"],support:["oakNatural","nosing"],productFilter:{series:"悦系列",wood:"橡木"},featured:false}),
  paving({id:"gallery-library",src:"journal/paving-reference/ref-gallery-library.webp",alt:"木构公共书廊与弧形地面参考",headline:"木构书廊",subline:"地面服从弧形动线与满墙书架",roomType:"公共空间",colorTone:"中棕",styleTag:"商业雅奢",pattern:"木作一体",mood:"沉静",wood:"橡木",series:"境系列",summary:"公共书廊以弧形下沉区、满墙书架与楼梯形成沉浸感，连续的中棕木色承接阅读动线，并统一大面积木作。",detailPoints:["空间观感：书架、楼梯与弧形空间共同形成沉浸感。","木色建议：中棕可统一大量木作，局部照明负责拉开层次。","铺法建议：地面应先服从弧形边界和高频通行，再安排板向。"],support:["oakBrown","section"],productFilter:{series:"境系列",wood:"橡木"},featured:false}),
  paving({id:"showroom-wide",src:"journal/paving-reference/ref-showroom-wide.webp",alt:"大尺度木地板样板展厅铺装参考",headline:"木色样场",subline:"大面积铺陈用于比较颜色与尺度",roomType:"展厅",colorTone:"中棕",styleTag:"商业雅奢",pattern:"模块拼",mood:"明亮",wood:"橡木",series:"境系列",summary:"这是用大面积实铺比较不同木色与板幅的样板展厅。地面本身就是展品，因此分区、灯光和观看距离比统一通铺更重要。",detailPoints:["空间观感：开阔、直接，适合同时比较多组木色。","木色建议：样板区需保留真实差异，不宜用统一滤镜或过暖灯光。","铺法建议：按样板模数组块排布，分界线要清楚并便于后期更换。"],support:["oakNatural","section"],productFilter:{series:"境系列",wood:"橡木"},featured:false}),
  paving({id:"atelier-commercial",src:"journal/paving-reference/ref-atelier-commercial.webp",alt:"木地板材料展厅分区铺装参考",headline:"材料展台",subline:"不同木色分区陈列",roomType:"展厅",colorTone:"中棕",styleTag:"商业雅奢",pattern:"模块拼",mood:"沉静",wood:"橡木",series:"境系列",summary:"画面是木地板材料展厅，多种地面与墙面样板并置。中部展台保持克制，便于在同一光线下比较纹理、色阶和板幅。",detailPoints:["空间观感：专业、沉稳，视觉重点落在材料本身。","木色建议：陈列区应同时保留浅、中、深色，避免单一色调误导选择。","铺法建议：样板按区域独立收边，主通道保持连续且耐磨。"],support:["oakBrown","section"],productFilter:{series:"境系列",wood:"橡木"},featured:false}),
  paving({id:"lounge-gray",src:"journal/paving-reference/ref-lounge-gray.webp",alt:"商业会客区烟熏灰木地板铺装参考",headline:"灰木会客",subline:"烟熏灰托住高饱和沙发",roomType:"商业空间",colorTone:"烟熏灰",styleTag:"现代极简",pattern:"通铺长板",mood:"沉静",wood:"橡木",series:"墨系列",summary:"亮蓝沙发是空间焦点，烟熏灰地面和白色石材墙负责把高饱和软装稳住。冷灰木色在明亮商业会客区里比深棕更清爽。",detailPoints:["空间观感：现代、冷静，彩色家具仍有明确落点。","木色建议：偏中性的烟熏灰更适合蓝色、黑色金属与白色石材。","铺法建议：大面积直铺即可，控制色差并减少多余装饰边框。"],support:["smoke","maintenance"],productFilter:{series:"墨系列",wood:"橡木"},featured:false}),
  paving({id:"retail-floor",src:"journal/paving-reference/ref-retail-floor.webp",alt:"木作公共共创空间分区地面参考",headline:"木作共创间",subline:"浅木地面承接展陈与讨论",roomType:"公共空间",colorTone:"原木",styleTag:"商业雅奢",pattern:"模块拼",mood:"明亮",wood:"欧橡",series:"境系列",summary:"展陈、讨论与动手操作在同一公共共创空间展开。不同浅木区域对应停留、阅读与工作，让开放空间仍有清楚的功能边界。",detailPoints:["空间观感：开放、亲近，适合多人停留与交流。","木色建议：浅原木可降低公共空间的机构感，并与木质家具协调。","铺法建议：按活动区模块化分区，高频通道保持平整、易维护。"],support:["oakNatural","maintenance"],productFilter:{series:"境系列",wood:"欧橡"},featured:false}),
  paving({id:"herringbone-tv",src:"journal/paving-reference/ref-herringbone-tv.webp",alt:"套房梳妆影音区深色鱼骨拼地板参考",headline:"套房鱼骨",subline:"深色拼法连接梳妆与影音区",roomType:"卧室",colorTone:"深胡桃",styleTag:"意式沉稳",pattern:"鱼骨拼",mood:"温润",wood:"黑胡桃",series:"墨系列",summary:"画面出现梳妆台、收纳柜与电视，更接近卧室套房的复合功能区。深色鱼骨拼给分散家具建立统一的视觉底盘。",detailPoints:["空间观感：家具较多，地面拼法提供稳定秩序。","木色建议：深胡桃可承接传统木家具，但墙面和床品宜保持浅色。","铺法建议：以电视柜或房间中轴定位鱼骨尖角，边缘预排完整收口。"],support:["deep","section"],productFilter:{series:"墨系列",wood:"黑胡桃"},featured:false}),
  paving({id:"herringbone-light",src:"journal/paving-reference/ref-herringbone-light.webp",alt:"临窗休闲区浅色人字拼地板参考",headline:"窗台成席",subline:"浅色人字拼放大临窗一角",roomType:"休闲区",colorTone:"原木",styleTag:"现代极简",pattern:"人字拼",mood:"明亮",wood:"橡木",series:"悦系列",summary:"这是一处紧邻落地窗的抬高休闲角。浅色人字拼在小面积里制造节奏，窗帘、绿植与坐垫则保持克制。",detailPoints:["空间观感：临窗区域被明确成一个可坐、可读的角落。","木色建议：浅原木能保留日照感，纹理可比大空间略活跃。","铺法建议：先对齐窗边与平台边框，再从中心向两侧排人字。"],support:["oakNatural","skirting"],productFilter:{series:"悦系列",wood:"橡木"},featured:false}),
  paving({id:"herringbone-dining",src:"journal/paving-reference/ref-herringbone-dining.webp",alt:"开放餐厅原木鱼骨拼地板参考",headline:"鱼骨入席",subline:"拼花围合餐桌与开放厨房",roomType:"餐厨",colorTone:"原木",styleTag:"现代极简",pattern:"鱼骨拼",mood:"明亮",wood:"橡木",series:"境系列",summary:"餐桌位于开放厨房与客厅之间，鱼骨拼自然形成用餐区的视觉中心。原木色避免拼花过重，也能连接楼梯下方的木作。",detailPoints:["空间观感：餐区集中，客厅与厨房仍保持开放。","木色建议：中性原木色适合大面积鱼骨拼，不易显得繁复。","铺法建议：以餐桌和房间中轴共同定位，四周边界保持完整尖角。"],support:["oakNatural","section"],productFilter:{series:"境系列",wood:"橡木"},featured:false}),
  paving({id:"gray-corridor",src:"journal/paving-reference/ref-gray-corridor.webp",alt:"开放客厅与厨房烟熏灰地板通铺参考",headline:"灰木通厅",subline:"冷灰地面连起客厅与开放厨房",roomType:"客厅",colorTone:"烟熏灰",styleTag:"现代极简",pattern:"通铺长板",mood:"明亮",wood:"橡木",series:"墨系列",summary:"客厅与开放厨房连成一体，烟熏灰长板沿主要动线延伸，把灰色沙发、黑色厨具和白墙收进同一冷静基调。",detailPoints:["空间观感：纵向动线清楚，客厅与厨房没有门槛分割。","木色建议：偏冷烟熏灰可协调黑白灰家具，避免混入过红木色。","铺法建议：沿客厅至厨房的主要动线连续排板，岛台周边整板优先。"],support:["smoke","skirting"],productFilter:{series:"墨系列",wood:"橡木"},featured:false}),
  paving({id:"wide-board-house",src:"journal/paving-reference/ref-wide-board-house.webp",alt:"开放大客厅原木宽板铺装参考",headline:"通厅宽板",subline:"大开间用少接缝保留尺度",roomType:"客厅",colorTone:"原木",styleTag:"自然侘寂",pattern:"宽板",mood:"明亮",wood:"欧橡",series:"森系列",summary:"客厅、餐厨与楼梯在同一大开间中，宽板以较少接缝维持整体尺度。自然纹理足够丰富，家具和木作不必再堆叠复杂线条。",detailPoints:["空间观感：通厅开阔，地面成为连接各功能区的背景。","木色建议：中性原木色适合大面积使用，也便于搭配深浅家具。","铺法建议：按最长开间连续排板，并为大面积地面预留规范伸缩空间。"],support:["oakNatural","section"],productFilter:{series:"森系列",wood:"欧橡"},featured:false}),
  paving({id:"plank-sun",src:"journal/paving-reference/ref-plank-sun.webp",alt:"落地窗休闲区日照下原木地板参考",headline:"日照验色",subline:"同一木色在直射光与阴影中不同",roomType:"休闲区",colorTone:"原木",styleTag:"自然侘寂",pattern:"通铺长板",mood:"明亮",wood:"橡木",series:"悦系列",summary:"两把椅子前的地面同时落在直射光和深影里，清楚展示木色会随时间改变观感。选材时不能只看均匀灯光下的一块样板。",detailPoints:["空间观感：窗边安静，光影本身成为主要装饰。","木色建议：将样板同时放在窗边与室内阴影处，确认冷暖和反光。","铺法建议：板向可顺着临窗开间，减少强光下接缝的视觉干扰。"],support:["oakNatural","maintenance"],productFilter:{series:"悦系列",wood:"橡木"},featured:false}),
  paving({id:"dark-tea",src:"journal/paving-reference/ref-dark-tea.webp",alt:"玄关连接抬高茶室的原木模块拼参考",headline:"入户见席",subline:"木地面完成玄关到茶室的过渡",roomType:"茶室",colorTone:"原木",styleTag:"东方静奢",pattern:"模块拼",mood:"柔光",wood:"橡木",series:"森系列",summary:"画面展示玄关与抬高茶室相连的关系。原木小模块从入口铺向坐席边缘，深色框架负责界定茶室，而不是让整间空间都变暗。",detailPoints:["空间观感：入户、踏步与茶席层次清楚，明暗对比集中在框景。","木色建议：入口用自然原木色可缓和深色框架，也便于衔接白墙。","铺法建议：先定玄关标高、茶室踏步和模块边框，再完成三处收口。"],support:["oakNatural","skirting"],productFilter:{series:"森系列",wood:"橡木"},featured:false})
];

var CASE_FILTER_DEFS=[
  {key:"roomType",label:"房间类型",all:"全部空间",options:["全部空间","客厅","餐厨","卧室","休闲区","多功能区","茶室","玄关","楼梯","展厅","公共空间","商业空间"]},
  ...
  {key:"pattern",label:"铺法",all:"全部铺法",options:["全部铺法","通铺长板","人字拼","鱼骨拼","宽板","模块拼","木作一体"]},
...
function renderProductSpaceShortcuts(){
  ...
  el.innerHTML=getProductSpaceShortcuts().map(function(item){
    var active=item.id===activeProductSpaceId;
    return '<button class="space-shortcut'+(active?' active':'')+'" type="button" data-space-id="'+item.id+'" aria-pressed="'+(active?'true':'false')+'" aria-label="按'+escapeHtml(item.roomType)+'筛选产品"><span>'+escapeHtml(item.roomType)+'</span><em>'+escapeHtml(item.colorTone)+' / '+escapeHtml(item.pattern)+'</em></button>';
  }).join("");
}

function renderProductSpaceRecommendation(item,list){
  var root=document.getElementById("prodSpaceRecommendation");
  if(!root)return;
  if(!item||item.id!==activeProductSpaceId){
    root.hidden=true;
    root.innerHTML="";
    return;
  }
  root.hidden=false;
  if(!PRODUCTS.length){
    root.innerHTML='<div class="space-recommendation-status"><span>MATCHING</span><strong>正在匹配'+escapeHtml(item.roomType)+'产品</strong><p>产品纹理与规格载入后会在这里显示。</p></div>';
    return;
  }
  list=list||getFiltered();
  if(!list.length){
    root.innerHTML='<div class="space-recommendation-status"><span>NO MATCH</span><strong>暂时没有完全匹配的产品</strong><p>可减少筛选条件，或联系顾问按空间条件继续匹配。</p><button type="button" data-space-recommendation-clear>清除筛选</button></div>';
    return;
  }
...
function syncProductSpaceRecommendation(list){
  renderProductSpaceRecommendation(activeProductSpaceId?getSpaceById(activeProductSpaceId):null,list);
}
...
function renderCaseGallery(){
  ...
  el.querySelectorAll(".space-gallery-card[data-space-id]").forEach(function(card){
    card.addEventListener("click",function(e){
      if(e.target.closest("[data-case-save]"))return;
      e.preventDefault();
      e.stopPropagation();
      openSpaceCase(card.getAttribute("data-space-id"));
    });
  });
  playSpaceVideos(el);
...
function applyProductFilterObject(filter,spaceItem){
  ...
  filter=filter||{};
  activeProductSpaceId=spaceItem&&spaceItem.id?spaceItem.id:"";
...
function getPavingCaseCommentary(item){
  ...
  var roomText={
    ...
    "休闲区":"休闲区先看坐、读与停留的位置，木纹应服务于尺度和光线，不必刻意做满。",
    "多功能区":"多功能区需要为用途变化留余地，木色和铺法宜清楚、耐看，避免限定单一家具布局。",
    ...
    "公共空间":"公共空间既要组织人流，也要照顾停留与维护，材料分区应清楚而不过度装饰。",
  ...
  return [
    ...
    {label:"PAVING",title:"铺装取向",text:item.pattern+"；"+(item.detailPoints&&item.detailPoints[2]?String(item.detailPoints[2]).replace(/^铺法建议[:：]/,""):"先确定主视线，再安排铺装方向。")}
  ];
}
...
function initSpaceExperience(){
  ...
  document.addEventListener("click",function(e){
    var productPath=e.target.closest(".selection-command-steps a[href='#products']");
    if(productPath&&getBaseHash(window.location.hash)==="#products"){
      e.preventDefault();
      var productFilters=document.getElementById("prodFilters");
      if(productFilters)productFilters.scrollIntoView({behavior:"smooth",block:"start"});
      return;
    }
    ...
    if(shortcut){
      ...
      if(shortcutItem)applyProductFilterObject(shortcutItem.productFilter,shortcutItem);
      return;
    }
    var recommendationProduct=e.target.closest("[data-space-product-code]");
    if(recommendationProduct){
      e.preventDefault();
      var recommended=findProductByCode(recommendationProduct.getAttribute("data-space-product-code"));
      if(recommended)selectProd(recommended);
      return;
    }
    if(e.target.closest("[data-space-recommendation-results]")){
      e.preventDefault();
      var productResults=document.getElementById("prodGrid");
      if(productResults)productResults.scrollIntoView({behavior:"smooth",block:"start"});
      return;
    }
    if(e.target.closest("[data-space-recommendation-clear]")){
      e.preventDefault();
      clearProductFilters();
      return;
    }
    ...
    if(productBtn){
      ...
      if(caseItem)applyProductFilterObject(caseItem.productFilter,caseItem);
      return;
    }
...
var IMAGE_SLOT_MAP=[
  ...
  {id:"S01",route:"#home",page:"首页",selector:"#homeSpaceFeature [data-space-id='living-hero']",title:"首页空间应用主图：一厅两景",asset:"journal/paving-reference/ref-living-hero.webp"},
  {id:"S02",route:"#home",page:"首页",selector:"#homeSpaceGrid [data-space-id='living-light']",title:"首页空间应用卡：窗边轻厅",asset:"journal/paving-reference/ref-living-light.webp"},
  {id:"S03",route:"#home",page:"首页",selector:"#homeSpaceGrid [data-space-id='living-dark-lounge']",title:"首页空间应用卡：小厅有序",asset:"journal/paving-reference/ref-living-dark-lounge.webp"},
  {id:"S04",route:"#home",page:"首页",selector:"#homeSpaceGrid [data-space-id='living-soft-sofa']",title:"首页空间应用卡：柔光会客",asset:"journal/paving-reference/ref-living-soft-sofa.webp"},
  {id:"S05",route:"#home",page:"首页",selector:"#homeSpaceGrid [data-space-id='living-warm-classic']",title:"首页空间应用卡：木顶卧居",asset:"journal/paving-reference/ref-living-warm-classic.webp"},
  {id:"S06",route:"#home",page:"首页",selector:"#homeSpaceGrid [data-space-id='dining-open']",title:"首页空间应用卡：餐厨相连",asset:"journal/paving-reference/ref-dining-open.webp"},
  {id:"S07",route:"#home",page:"首页",selector:"#homeSpaceGrid [data-space-id='dining-light']",title:"首页空间应用卡：一室两用",asset:"journal/paving-reference/ref-dining-light.webp"},
  {id:"S08",route:"#home",page:"首页",selector:"#homeSpaceGrid [data-space-id='dining-minimal']",title:"首页空间应用卡：餐厅作轴",asset:"journal/paving-reference/ref-dining-minimal.webp"},
...
{id:"C01",route:"#cases",page:"铺装参考库",selector:"#caseSpaceGallery [data-space-id='living-hero']",title:"铺装参考：一厅两景",asset:"journal/paving-reference/ref-living-hero.webp"},
  {id:"C02",route:"#cases",page:"铺装参考库",selector:"#caseSpaceGallery [data-space-id='living-light']",title:"铺装参考：窗边轻厅",asset:"journal/paving-reference/ref-living-light.webp"},
  {id:"C03",route:"#cases",page:"铺装参考库",selector:"#caseSpaceGallery [data-space-id='living-dark-lounge']",title:"铺装参考：小厅有序",asset:"journal/paving-reference/ref-living-dark-lounge.webp"},
  {id:"C04",route:"#cases",page:"铺装参考库",selector:"#caseSpaceGallery [data-space-id='living-soft-sofa']",title:"铺装参考：柔光会客",asset:"journal/paving-reference/ref-living-soft-sofa.webp"},
  {id:"C05",route:"#cases",page:"铺装参考库",selector:"#caseSpaceGallery [data-space-id='living-warm-classic']",title:"铺装参考：木顶卧居",asset:"journal/paving-reference/ref-living-warm-classic.webp"},
  {id:"C06",route:"#cases",page:"铺装参考库",selector:"#caseSpaceGallery [data-space-id='dining-open']",title:"铺装参考：餐厨相连",asset:"journal/paving-reference/ref-dining-open.webp"},
  {id:"C07",route:"#cases",page:"铺装参考库",selector:"#caseSpaceGallery [data-space-id='dining-light']",title:"铺装参考：一室两用",asset:"journal/paving-reference/ref-dining-light.webp"},
  {id:"C08",route:"#cases",page:"铺装参考库",selector:"#caseSpaceGallery [data-space-id='dining-minimal']",title:"铺装参考：餐厅作轴",asset:"journal/paving-reference/ref-dining-minimal.webp"},
  {id:"C09",route:"#cases",page:"铺装参考库",selector:"#caseSpaceGallery [data-space-id='kitchen-ceiling']",title:"铺装参考：梁下餐厨",asset:"journal/paving-reference/ref-kitchen-ceiling.webp"},
  {id:"C10",route:"#cases",page:"铺装参考库",selector:"#caseSpaceGallery [data-space-id='kitchen-long']",title:"铺装参考：长桌成心",asset:"journal/paving-reference/ref-kitchen-long.webp"},
  {id:"C11",route:"#cases",page:"铺装参考库",selector:"#caseSpaceGallery [data-space-id='kitchen-family']",title:"铺装参考：家务共桌",asset:"journal/paving-reference/ref-kitchen-family.webp"},
  {id:"C12",route:"#cases",page:"铺装参考库",selector:"#caseSpaceGallery [data-space-id='bedroom-light']",title:"铺装参考：抬高一隅",asset:"journal/paving-reference/ref-bedroom-light.webp"},
  {id:"C13",route:"#cases",page:"铺装参考库",selector:"#caseSpaceGallery [data-space-id='bedroom-deep']",title:"铺装参考：窗边静坐",asset:"journal/paving-reference/ref-bedroom-deep.webp"},
  {id:"C14",route:"#cases",page:"铺装参考库",selector:"#caseSpaceGallery [data-space-id='bedroom-warm']",title:"铺装参考：暖阳客厅",asset:"journal/paving-reference/ref-bedroom-warm.webp"},
  {id:"C15",route:"#cases",page:"铺装参考库",selector:"#caseSpaceGallery [data-space-id='study-shadow']",title:"铺装参考：材质入门",asset:"journal/paving-reference/ref-study-shadow.webp"},
  {id:"C16",route:"#cases",page:"铺装参考库",selector:"#caseSpaceGallery [data-space-id='study-chair']",title:"铺装参考：双椅静谈",asset:"journal/paving-reference/ref-study-chair.webp"},
  {id:"C17",route:"#cases",page:"铺装参考库",selector:"#caseSpaceGallery [data-space-id='tea-room-dark']",title:"铺装参考：木顶茶席",asset:"journal/paving-reference/ref-tea-room-dark.webp"},
  {id:"C18",route:"#cases",page:"铺装参考库",selector:"#caseSpaceGallery [data-space-id='tatami-light']",title:"铺装参考：障子明室",asset:"journal/paving-reference/ref-tatami-light.webp"},
  {id:"C19",route:"#cases",page:"铺装参考库",selector:"#caseSpaceGallery [data-space-id='japanese-quiet']",title:"铺装参考：席边素木",asset:"journal/paving-reference/ref-japanese-quiet.webp"},
  {id:"C20",route:"#cases",page:"铺装参考库",selector:"#caseSpaceGallery [data-space-id='entry-slats']",title:"铺装参考：移门之后",asset:"journal/paving-reference/ref-entry-slats.webp"},
  {id:"C21",route:"#cases",page:"铺装参考库",selector:"#caseSpaceGallery [data-space-id='corridor-wood']",title:"铺装参考：双床木室",asset:"journal/paving-reference/ref-corridor-wood.webp"},
  {id:"C22",route:"#cases",page:"铺装参考库",selector:"#caseSpaceGallery [data-space-id='hall-open']",title:"铺装参考：转角见景",asset:"journal/paving-reference/ref-hall-open.webp"},
  {id:"C23",route:"#cases",page:"铺装参考库",selector:"#caseSpaceGallery [data-space-id='stairs-open']",title:"铺装参考：楼梯连庭",asset:"journal/paving-reference/ref-stairs-open.webp"},
  {id:"C24",route:"#cases",page:"铺装参考库",selector:"#caseSpaceGallery [data-space-id='stairs-silent']",title:"铺装参考：斜顶连层",asset:"journal/paving-reference/ref-stairs-silent.webp"},
  {id:"C25",route:"#cases",page:"铺装参考库",selector:"#caseSpaceGallery [data-space-id='gallery-library']",title:"铺装参考：木构书廊",asset:"journal/paving-reference/ref-gallery-library.webp"},
  {id:"C26",route:"#cases",page:"铺装参考库",selector:"#caseSpaceGallery [data-space-id='showroom-wide']",title:"铺装参考：木色样场",asset:"journal/paving-reference/ref-showroom-wide.webp"},
  {id:"C27",route:"#cases",page:"铺装参考库",selector:"#caseSpaceGallery [data-space-id='atelier-commercial']",title:"铺装参考：材料展台",asset:"journal/paving-reference/ref-atelier-commercial.webp"},
  {id:"C28",route:"#cases",page:"铺装参考库",selector:"#caseSpaceGallery [data-space-id='lounge-gray']",title:"铺装参考：灰木会客",asset:"journal/paving-reference/ref-lounge-gray.webp"},
  {id:"C29",route:"#cases",page:"铺装参考库",selector:"#caseSpaceGallery [data-space-id='retail-floor']",title:"铺装参考：木作共创间",asset:"journal/paving-reference/ref-retail-floor.webp"},
  {id:"C30",route:"#cases",page:"铺装参考库",selector:"#caseSpaceGallery [data-space-id='herringbone-tv']",title:"铺装参考：套房鱼骨",asset:"journal/paving-reference/ref-herringbone-tv.webp"},
  {id:"C31",route:"#cases",page:"铺装参考库",selector:"#caseSpaceGallery [data-space-id='herringbone-light']",title:"铺装参考：窗台成席",asset:"journal/paving-reference/ref-herringbone-light.webp"},
  ...
  {id:"C33",route:"#cases",page:"铺装参考库",selector:"#caseSpaceGallery [data-space-id='gray-corridor']",title:"铺装参考：灰木通厅",asset:"journal/paving-reference/ref-gray-corridor.webp"},
  {id:"C34",route:"#cases",page:"铺装参考库",selector:"#caseSpaceGallery [data-space-id='wide-board-house']",title:"铺装参考：通厅宽板",asset:"journal/paving-reference/ref-wide-board-house.webp"},
  {id:"C35",route:"#cases",page:"铺装参考库",selector:"#caseSpaceGallery [data-space-id='plank-sun']",title:"铺装参考：日照验色",asset:"journal/paving-reference/ref-plank-sun.webp"},
  {id:"C36",route:"#cases",page:"铺装参考库",selector:"#caseSpaceGallery [data-space-id='dark-tea']",title:"铺装参考：入户见席",asset:"journal/paving-reference/ref-dark-tea.webp"}
];
...
var seriesData={
  ...
  "墨系列":{
    ...
    hero:"墨系列适合偏好深色木纹、沉稳空间和现代轻奢风格的选择，强调视觉秩序、空间压舱感，以及与高级灰、石材、金属等材质的搭配。",
    features:[
...
function initPremiumInteractions(){
  ...
  var pressableSelector=[
    ...
    '.journal-hero-card','.journal-mini-card','.craft-item','.phase-card-header',
  ...
  var motionCardSelector=[
    '.case-card','.space-card','.space-feature-card','.space-gallery-card','.journal-topic','.craft-item','.phase-card','.contact-card',
